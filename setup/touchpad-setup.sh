...
# Enables tap-to-click on Debian 13 (X11 + libinput, i3 or any WM).
#
# Two modes:
...
fail "xserver-xorg-input-libinput is not installed. Tapping options for the libinput driver won't apply. Install it with: sudo apt install xserver-xorg-input-libinput"
fi
...
fail "xinput not found. Install it with: sudo apt install xinput"
fi
local name
